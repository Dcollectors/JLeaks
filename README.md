...
## Contents of JLeaks
So far, JLeaks contains **`1,545`** real-world resource leaks from open-source Java projects. Detailed information about these defects can be found in the **`JLeaks.xlsx`**.
